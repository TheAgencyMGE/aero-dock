...
Windows dock that takes the Frutiger Aero look seriously. Contributions
that fit that goal are welcome.
...
- **Tell the user when their action fails.** The dock has no console, so
